...
const getCardinal = (angle) => {
  ...
  if (angle >= 0 && angle < degree) return 'Nord';
  if (angle >= degree && angle < 2 * degree) return 'NordØst';
  if (angle >= 2 * degree && angle < 3 * degree) return 'Øst';
  if (angle >= 3 * degree && angle < 4 * degree) return 'SydØst';
  if (angle >= 4 * degree && angle < 5 * degree) return 'Syd';
  if (angle >= 5 * degree && angle < 6 * degree) return 'SydVest';
  if (angle >= 6 * degree && angle < 7 * degree) return 'Vest';
  if (angle >= 7 * degree && angle < 8 * degree) return 'NordVest';
  //Should never happen:
  return 'Nord';
};
